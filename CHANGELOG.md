...
- Prevent cancelled meta protocol operations from leaving reusable, stream-misaligned connections
- Consume parsed responses immediately instead of deferring buffer advancement to the next operation
