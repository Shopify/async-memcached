...
// TODO: Fill this out with the rest of the meta flags that can be returned by meta protocol responses
// Should this be an all-encompassing struct that includes all possible flags, or split for each meta command?
/// A value from memcached generated by a meta protocol response.
...
/// Memcached value generated by either an ASCII or meta protocol response.
#[derive(Clone, Debug, PartialEq)]
pub enum MemcachedValue {
    /// A value generated by an ASCII protocol response.
    Value(Value),
    /// A value generated by a meta protocol response.
    MetaValue(MetaValue),
}
...
pub enum Response {
    ...
    Data(Option<Vec<MemcachedValue>>),
